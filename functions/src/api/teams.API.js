...
async function getTeamMeta() {
    ...
    let roster_labels = (_b = (_a = detailedRoster.values) === null || _a === void 0 ? void 0 : _a.splice(0, 1).map((a) => a.map(sheets.clean))) !== null && _b !== void 0 ? _b : [];
    // @ts-ignore
...
async function getTeamLeadership(players) {
    ...
    let leadership_labels = (_b = (_a = teamLeadership.values) === null || _a === void 0 ? void 0 : _a.splice(0, 1).map((a) => a.map(sheets.clean))) !== null && _b !== void 0 ? _b : [[]];
