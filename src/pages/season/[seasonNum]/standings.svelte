<script>
    ...
    import {teamStoreFactory, standingsStoreFactory} from "../../../helpers/firebase/FirestoreCacheStoreFactory";
    import StandingsMapper from "../../../components/Standings/StandingsMapper.svelte";
    import {getContext} from "svelte";

    const seasonNum = getContext("seasonNum");
    let _teams, _standings;
...
<CachedQuery store={teamStoreFactory()} on:data={(e)=>_teams = e.detail.data}>
    <CachedQuery store={standingsStoreFactory()} on:data={(e)=>_standings = e.detail.data}>
        ...
        <StandingsMapper {_teams} {seasonNum} {league} {_standings} let:teams>
